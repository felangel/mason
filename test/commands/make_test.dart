    ...
    test('--help shows correct help information', overridePrint(() async {
      const expectedPrintLogs = <String>[
        'Generate code using an existing brick template.\n'
            ...
            '                                (defaults to ".")\n'
            '''    --on-conflict               By default, the user will be prompted to specify how file conflicts should be resolved. Enabling this flag allows the user to customize how file conflicts are resolved.\n'''
            '\n'
