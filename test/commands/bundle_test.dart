...
void main() {
  ...
  group('mason bundle', () {
    ...
    test('creates a new universal bundle (with hooks)', () async {
      ...
      final expected =
          '''{"files":[{"path":"hooks.md","data":"SGkge3tuYW1lfX0h","type":"text"}],"hooks":[{"path":"post_gen.dart","data":"aW1wb3J0ICdkYXJ0OmlvJzsKCnZvaWQgbWFpbigpIHsKICBmaW5hbCBmaWxlID0gRmlsZSgnLnBvc3RfZ2VuLnR4dCcpOwogIGZpbGUud3JpdGVBc1N0cmluZ1N5bmMoJ3Bvc3RfZ2VuOiB7e25hbWV9fScpOwp9Cg==","type":"text"},{"path":"pre_gen.dart","data":"aW1wb3J0ICdkYXJ0OmlvJzsKCnZvaWQgbWFpbigpIHsKICBmaW5hbCBmaWxlID0gRmlsZSgnLnByZV9nZW4udHh0Jyk7CiAgZmlsZS53cml0ZUFzU3RyaW5nU3luYygncHJlX2dlbjoge3tuYW1lfX0nKTsKfQo=","type":"text"}],"name":"hooks","description":"A Hooks Example Template","vars":["name"]}''';
      expect(actual, equals(expected));
    });
    ...
    test('creates a new dart bundle (with hooks)', () async {
      ...
      expect(
        actual,
        contains(
          '''final hooksBundle = MasonBundle.fromJson(<String, dynamic>{"files":[{"path":"hooks.md","data":"SGkge3tuYW1lfX0h","type":"text"}],"hooks":[{"path":"post_gen.dart","data":"aW1wb3J0ICdkYXJ0OmlvJzsKCnZvaWQgbWFpbigpIHsKICBmaW5hbCBmaWxlID0gRmlsZSgnLnBvc3RfZ2VuLnR4dCcpOwogIGZpbGUud3JpdGVBc1N0cmluZ1N5bmMoJ3Bvc3RfZ2VuOiB7e25hbWV9fScpOwp9Cg==","type":"text"},{"path":"pre_gen.dart","data":"aW1wb3J0ICdkYXJ0OmlvJzsKCnZvaWQgbWFpbigpIHsKICBmaW5hbCBmaWxlID0gRmlsZSgnLnByZV9nZW4udHh0Jyk7CiAgZmlsZS53cml0ZUFzU3RyaW5nU3luYygncHJlX2dlbjoge3tuYW1lfX0nKTsKfQo=","type":"text"}],"name":"hooks","description":"A Hooks Example Template","vars":["name"]});''',
        ),
      );
    });
