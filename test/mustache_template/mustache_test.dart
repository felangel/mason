...
const isTemplateException = TypeMatcher<TemplateException>();

Matcher throwsTemplateException = throwsA(isTemplateException);
...
//        '');
    ...
    test('Bad tag', () {
      expect(() => Template('{{{ foo }|'), throwsTemplateException);
    });
  });
...
//		});
  ...
  group('Lambdas', () {
    ...
    test('LambdaContext.lookup closed', () {
      ...
      expect(() => lc2.lookup('foo'), throwsA(isA<TemplateException>()));
    });
  });
