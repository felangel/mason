...
[4]: https://youtu.be/G4PTjA6tpTU''';
        expect(
          lineSplitter.convert(readmeContent),
          lineSplitter.convert(expectedReadmeContent),
        );
        ...
        const expectedChangelogContent = '''
# 0.1.0+1

- TODO: Describe initial release.
''';
        expect(
          lineSplitter.convert(changelogContent),
          lineSplitter.convert(expectedChangelogContent),
        );
...
''';
        expect(
          lineSplitter.convert(licenseContent),
          lineSplitter.convert(expectedLicenseContent),
        );
      });
