...
import 'package:masonex/src/generator.dart';
  ...
  group(
    ...
    () {
      ...
      test('throws HookExecutionException on IsolateSpawnException', () async {
        final hookDirectoryPath =
            path.join('test', 'fixtures', 'basic', 'hooks');
        final files = [
          File(
            canonicalize(
              path.join(
          ...
          File(
            canonicalize(
              path.join(
                ...
                'hooks',
                'pre_gen',
                'pre_gen_e19e73f11217ea54ff2948c6d2d931fac9a51aa5.dart',
              ),
            ),
          ),
          File(
