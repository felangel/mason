      ...
      group('source path', () {
        test('creates a new universal bundle (no hooks)', () async {
          ...
          final actual = json.encode(
            (await MasonexBundle.fromUniversalBundle(file.readAsBytesSync()))
                .toJson(),
          );
          ...
          expect(
            actual,
            contains(
              '''{"files":[{"path":"GREETINGS.md","data":"SGkge3tuYW1lfX0h","type":"text"}],"hooks":[],"name":"greeting","description":"A Simple Greeting Template","version":"0.1.0+1","environment":{"masonex":"any"},''',
            ),
          );
          expect(actual, contains('"readme":{"path":"README.md","data":"'));
          expect(
            actual,
            contains('"changelog":{"path":"CHANGELOG.md","data":"'),
          );
        ...
        test('creates a new universal bundle (with hooks)', () async {
          ...
          expect(
            actual,
            contains(
              '''"name":"hooks","description":"A Hooks Example Template","version":"0.1.0+1","environment":{"masonex":"any"},"vars":{"name":{"type":"string","description":"Your name","default":"Dash","prompt":"What is your name?"}}''',
            ),
          );
        ...
        test('creates a new dart bundle (no hooks)', () async {
          ...
          expect(actual, contains("import 'package:masonex/masonex.dart'"));
          expect(
            actual,
            contains(
              '''final greetingBundle = MasonexBundle.fromJson(<String, dynamic>{"files":[{"path":"GREETINGS.md","data":"SGkge3tuYW1lfX0h","type":"text"}],"hooks":[],"name":"greeting","description":"A Simple Greeting Template","version":"0.1.0+1","environment":{"masonex":"any"},''',
            ),
          );
          expect(actual, contains('"readme":{"path":"README.md","data":"'));
          expect(
      ...
      group('set-exit-if-changed', () {
        ...
        group('with universal bundle', () {
          ...
          test('exits with code 70 when bundle was modified', () async {
            ...
            final bundle = await MasonexBundle.fromUniversalBundle(originalBytes);
            final bundleJson = jsonEncode(bundle.toJson())
                .replaceAll('greeting', 'modified_greeting');
            final modifiedBundle = MasonexBundle.fromJson(
