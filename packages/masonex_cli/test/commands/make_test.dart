...
void main() {
  ...
  group('masonex make', () {
      ...
      overridePrint(() async {
        const expectedPrintLogs = <String>[
          'Generate code using an existing brick template.\n'
              '\n'
              'Usage: masonex make <subcommand> [arguments]\n'
              ...
              '  favorite_color       A new brick created with the Masonex CLI.\n'
              '  favorite_languages   A new brick created with the Masonex CLI.\n'
              '  flavors              A new brick created with the Masonex CLI.\n'
      ...
      overridePrint(() async {
        const expectedPrintLogs = <String>[
          'A Simple Greeting Template\n'
              '\n'
              'Usage: masonex make greeting [arguments]\n'
              '-h, --help                      Print this usage information.\n'
              '-q, --quiet                     Run with reduced verbosity.\n'
              '    --no-hooks                  Skips running hooks.\n'
              '    --set-exit-if-changed       Return exit code 70 if there are files modified.\n'
      ...
      overridePrint(() async {
        const expectedPrintLogs = <String>[
          'A Legacy Greeting Template\n'
              '\n'
              'Usage: masonex make legacy [arguments]\n'
              '-h, --help                      Print this usage information.\n'
              '-q, --quiet                     Run with reduced verbosity.\n'
              '    --no-hooks                  Skips running hooks.\n'
              '    --set-exit-if-changed       Return exit code 70 if there are files modified.\n'
    ...
    test(
      ...
      overridePrint(() async {
        const expectedPrintLogs = <String>[
          'A Bio Template\n'
              '\n'
              'Usage: masonex make bio [arguments]\n'
              '-h, --help                      Print this usage information.\n'
              '-q, --quiet                     Run with reduced verbosity.\n'
              '    --no-hooks                  Skips running hooks.\n'
              '    --set-exit-if-changed       Return exit code 70 if there are files modified.\n'
      ...
      overridePrint(() async {
        const expectedPrintLogs = <String>[
          'A new brick created with the Masonex CLI.\n'
              '\n'
              'Usage: masonex make flavors [arguments]\n'
              '-h, --help                      Print this usage information.\n'
              '-q, --quiet                     Run with reduced verbosity.\n'
              '    --no-hooks                  Skips running hooks.\n'
              '    --set-exit-if-changed       Return exit code 70 if there are files modified.\n'
    ...
    test(
      ...
      overridePrint(() async {
        const expectedPrintLogs = <String>[
          'A new brick created with the Masonex CLI.\n'
              '\n'
              'Usage: masonex make favorite_color [arguments]\n'
              '-h, --help                      Print this usage information.\n'
              '-q, --quiet                     Run with reduced verbosity.\n'
              '    --no-hooks                  Skips running hooks.\n'
              '    --set-exit-if-changed       Return exit code 70 if there are files modified.\n'
    ...
    test('exits with code 64 when brick does not exist', () async {
      ...
      verify(
        () => logger.err(
          'Could not find a subcommand named "garbage" for "masonex make".',
        ),
      ).called(1);
    });
    ...
    test('exits with code 64 when missing subcommand', () async {
      ...
      expect(result, equals(ExitCode.usage.code));
      verify(
        () => logger.err('Missing subcommand for "masonex make".'),
      ).called(1);
    });
...
in todos.json''',
    ...
    test('exits with code 64 when masonex.yaml contains mismatch', () async {
      File(path.join(Directory.current.path, 'masonex.yaml')).writeAsStringSync(
        '''
bricks:
  app_icon1:
...
''',
      ...
      const expectedErrorMessage =
          '''Could not find a subcommand named "app_icon1" for "masonex make".''';
    ...
    test('throws FormatException when enum values is empty', () async {
      ...
      final result = await MasonexCommandRunner(
        logger: logger,
        pubUpdater: pubUpdater,
...
''');
      ...
      File(path.join(tempDirectory.path, MasonexYaml.file))
        ..createSync(recursive: true)
      ...
      final make = command.subcommands[watchBrick]! as MasonexCommand
