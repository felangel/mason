...
/// `masonex new` command which creates a new brick.
/// {@endtemplate}
class NewCommand extends MasonexCommand {
  /// {@macro new_command}
  NewCommand({super.logger}) {
    argParser
      ...
      ..addOption(
        ...
        defaultsTo: 'A new brick created with the Masonex CLI.',
      )
      ..addOption(
        'output-dir',
        abbr: 'o',
...
class _BrickGenerator extends MasonexGenerator {
  _BrickGenerator(
    this.brickName,
