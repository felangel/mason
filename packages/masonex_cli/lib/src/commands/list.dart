...
/// `masonex list` command which lists all available bricks.
/// {@endtemplate}
class ListCommand extends MasonexCommand {
  /// {@macro list_command}
  ...
  Future<int> run() async {
    ...
    logger.info(isGlobal ? path.dirname(globalMasonexYamlFile.path) : cwd.path);
