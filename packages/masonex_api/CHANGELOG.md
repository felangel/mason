...
- deps: tighten dependency constraints ([#1400](https://github.com/felangel/masonex/issues/1400))
...
- feat: add `search` to `MasonexApi`

# 0.1.0-dev.4

- feat: add `details` to `MasonexApiException`
