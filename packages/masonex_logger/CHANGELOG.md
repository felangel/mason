...
- deps: upgrade `pkg:win32` to `^5.11.0` ([#1537](https://github.com/felangel/masonex/pull/1537))

# 0.3.2

- fix: `link` should depend on ansi escape support ([#1505](https://github.com/felangel/masonex/pull/1505))
...
- feat: add `interval` to `ProgressAnimation` ([#1391](https://github.com/felangel/masonex/issues/1391))
- deps: tighten dependency constraints ([#1395](https://github.com/felangel/masonex/issues/1395))
...
- refactor: upgrade `pkg:win32` to `^0.5.4` ([#1300](https://github.com/felangel/masonex/issues/1300))
  - bumps the Dart SDK minimum version up to `3.3.0`

# 0.2.14

- fix: `The getter 'STD_HANDLE' isn't defined for the class 'WindowsTerminal' ([#1298](https://github.com/felangel/masonex/issues/1298))

# 0.2.13

- fix: throw `StateError` when prompting with no terminal attached ([#1285](https://github.com/felangel/masonex/issues/1285))
- refactor: remove deprecated methods in `WindowsTerminal` ([#1286](https://github.com/felangel/masonex/issues/1286))

# 0.2.12

- feat: add `trailing` to `ProgressOptions` ([#1247](https://github.com/felangel/masonex/issues/1247))

# 0.2.11

- chore: fix missing closing doc template
- chore: use `pkg:io` ([#1099](https://github.com/felangel/masonex/issues/1099))

# 0.2.10

- fix: exit on Ctrl+C ([#1090](https://github.com/felangel/masonex/issues/1090))
...
- feat: add `ProgressOptions` API
  ...
  ```dart
  import 'package:masonex_logger/masonex_logger.dart';
...
- feat: add `link` API
  ...
  final repoLink = link(
    ...
    uri: Uri.parse('https://github.com/felangel/masonex'),
  );
