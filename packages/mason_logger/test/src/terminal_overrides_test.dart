...
void main() {
  group(TerminalOverrides, () {
    group('runZoned', () {
      ...
      test('uses current readKey when not specified '
      ...
      test('uses nested readKey when specified '
          'and zone already contains a readKey', () {
      ...
      test('uses custom createTerminal when specified', () {
        ...
        TerminalOverrides.runZoned(() {
          final overrides = TerminalOverrides.current;
          expect(overrides!.createTerminal(), equals(terminal));
        }, createTerminal: () => terminal);
      });

      test('uses current createTerminal when not specified '
      ...
      test('uses nested readKey when specified '
        ...
        TerminalOverrides.runZoned(() {
          ...
          final overrides = TerminalOverrides.current;
          expect(overrides!.createTerminal(), equals(rootTerminal));
          TerminalOverrides.runZoned(() {
            final overrides = TerminalOverrides.current;
            expect(overrides!.createTerminal(), equals(nestedTerminal));
      ...
      test('uses current exit when not specified '
      ...
      test('uses nested exit when specified '
          'and zone already contains a exit', () {
